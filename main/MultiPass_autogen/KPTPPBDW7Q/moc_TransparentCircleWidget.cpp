...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTransparentCircleWidgetENDCLASS_t qt_meta_stringdata_CLASSTransparentCircleWidgetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(24, 13),  // "widgetClicked"
        QT_MOC_LITERAL(38, 0),  // ""
        QT_MOC_LITERAL(39, 10),  // "updateSize"
...
void TransparentCircleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->widgetClicked((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        case 1: _t->updateSize((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TransparentCircleWidget::*)(const QPoint );
            if (_t _q_method = &TransparentCircleWidget::widgetClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TransparentCircleWidget::widgetClicked(const QPoint _t1)
{
